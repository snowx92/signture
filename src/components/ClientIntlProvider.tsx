...
const messagesEn = {
  ...
  "hero.subtitle": "Shaping the Visionaries of Tomorrow, Today",
  "hero.slogan": "Train today, Lead tomorrow",
  "hero.description":
    "At Signature Academy, we nurture young minds through world-class education rooted in {values}, {creativity}, and {innovation}. Our globally recognized programs and expert educators prepare students with the skills, confidence, and mindset to thrive in a changing world.",
  "hero.values": "values",
  ...
  "features.subtitle":
    "Discover what makes our academy the preferred choice for thousands of students and families worldwide.",
  "features.learnMore": "Learn more about our programs",
  "features.expert.title": "Expert Instructors",
  "features.expert.desc":
    "Learn from qualified educators with years of experience",
  "features.interactive.title": "Interactive Learning",
  "features.interactive.desc":
    "Engaging classroom activities and group discussions",
  "features.certified.title": "Certified Programs",
  "features.certified.desc":
    "Internationally recognized certificates and credentials",
  ...
  "features.personalized.desc":
    "Tailored approach to meet each student's unique needs",
  "features.innovative.title": "Innovative Methods",
  "features.innovative.desc":
    "Latest technology and creative teaching techniques",
  "features.supportive.title": "Supportive Environment",
  "features.supportive.desc":
    "Nurturing atmosphere where every student can thrive",
  ...
  "about.subtitle":
    "At Signature Academy, we cultivate the minds of future leaders through an uncompromising standard of excellence in education. Our prestigious programs blend tradition with innovation, instilling timeless values, refined creativity, and pioneering vision. Guided by world-class educators and enriched by a global perspective.",
  "about.mission.title": "Our Mission",
  "about.mission.text":
    "To deliver an unparalleled standard of education that inspires intellectual excellence, cultivates refined creativity, and instills a deep sense of integrity and purpose. At Signature Academy, we shape distinguished global citizens equipped with the wisdom, leadership, and cultural sophistication to make a lasting impact on the world.",
  "about.vision.title": "Our Vision",
  "about.vision.text":
    "To stand as the world's foremost institution of elite learning, uniting cultures and ideas while setting new benchmarks in academic prestige. We envision a generation of leaders—cultured, visionary, and principled—who shape the future with innovation, grace, and transformative influence.",
  "about.values.title": "Our Core Values",
  "about.values.subtitle":
    "These fundamental principles guide everything we do and shape the culture of our academy.",
  "about.values.care.title": "Care & Compassion",
  "about.values.care.desc":
    "Every child receives individual attention and support",
  ...
  "about.values.community.desc":
    "Creating strong bonds between families and school",
  "about.values.global.title": "Global Perspective",
  "about.values.global.desc":
    "Preparing culturally sophisticated leaders for an interconnected world",
  "about.values.leadership.title": "Leadership Development",
  "about.values.leadership.desc":
    "Cultivating visionary leaders with transformative influence",
  "about.aboutUs.title": "About Signature Academy",
  "about.aboutUs.text":
    "Signature Academy, the training arm of Signature Group, delivers accredited programs aligned with Egypt's Vision 2030 and the Bedaya Presidential Initiative. With expert trainers and internationally certified content, it bridges education and market needs in health, hospitality, and corporate development.",
  ...
  "programs.subtitle":
    "From early childhood to high school preparation, our programs are designed to nurture growth at every stage.",
  "programs.learnMore": "Learn More",
  "programs.early.title": "Early Childhood Education",
  "programs.early.desc":
    "Foundation building for ages 3-6 with play-based learning",
  "programs.elementary.title": "Elementary Excellence",
  "programs.elementary.desc":
    "Comprehensive curriculum focusing on core subjects",
  ...
  "programs.cta.desc":
    "Our education consultants can help you find the perfect program that matches your needs and interests. We offer a free 10-minute consultation with our expert to guide you towards the best choice.",
  ...
  "stats.subtitle":
    "These achievements reflect our commitment to excellence and the trust families place in us.",
  ...
  "testimonials.subtitle":
    "Real stories from families who trust us with their children's education.",

  // CTA Section
  "cta.title": "Ready to Begin Your Child's",
  "cta.titleHighlight": "Educational Journey?",
  "cta.subtitle":
    "Join our community of families who have chosen excellence in education. Enrollment is now open for the upcoming academic year.",
  "cta.badge": "Enrollment Open",
  "cta.card.title": "Secure Your Child's Spot Today",
  "cta.card.desc":
    "Limited spaces available for our premium programs. Schedule a visit to see why families choose us for their children's education.",
  ...
  "cta.features.flexible.desc":
    "Multiple enrollment periods throughout the year",
  ...
  "partners.subtitle":
    "We collaborate with renowned institutions and organizations worldwide to provide the highest quality education and opportunities for our students.",
  ...
  "partners.desc.1":
    "German excellence in educational standards and quality assurance",
  "partners.desc.2":
    "National authority for quality certification and educational standards",
  "partners.desc.3":
    "Leading Arab educational excellence and accreditation organization",
  "partners.desc.4":
    "Certified International Professional Accreditation Association",
  "partners.benefits.title": "Partnership Benefits",
  "partners.benefits.global.title": "Global Recognition",
  "partners.benefits.global.desc":
    "Internationally recognized certificates and qualifications",
  "partners.benefits.quality.title": "Quality Assurance",
  "partners.benefits.quality.desc":
    "High standards maintained through partner oversight",
  "partners.benefits.opportunities.title": "Enhanced Opportunities",
  "partners.benefits.opportunities.desc":
    "Access to global educational and career opportunities",
  ...
  "certificates.subtitle":
    "Our commitment to excellence is validated by prestigious certifications and awards from renowned international organizations.",
  ...
  "certificates.awards.subtitle":
    "Recognition of our continuous commitment to educational excellence and innovation",
  ...
  "certificates.quality.description":
    "Our rigorous quality standards ensure that every program meets international benchmarks for educational excellence.",
  ...
  "faq.subtitle":
    "Find answers to the most common questions about our programs, admission process, and services. Can't find what you're looking for? Contact us directly.",
  ...
  "faq.answer.1":
    "We welcome students from age 18 and above. Our programs are designed to meet the learning needs and developmental goals of adult learners.",
  "faq.answer.2":
    "Our courses are offered in both English and Arabic. We believe in bilingual education that helps students become globally competitive while maintaining their cultural identity. Most of our programs offer instruction in both languages, with some specialized courses available in English only.",
  "faq.answer.3":
    "Our certificates are internationally accredited and can be authenticated by the Ministry of Foreign Affairs.",
  "faq.answer.4":
    "Our admission process is simple and straightforward: 1) Submit an online application, 2) Schedule a placement assessment, 3) Attend an interview with our educational consultants, 4) Receive acceptance letter, 5) Complete enrollment. We also offer a free 10-minute consultation to help you choose the right program.",
  "faq.answer.5":
    "Yes, we offer flexible learning options including online, hybrid, and in-person classes. Our digital learning platform provides interactive lessons, virtual classrooms, and comprehensive support. Students can choose the format that best suits their needs and schedule.",
  "faq.answer.6":
    "We provide comprehensive support including academic tutoring, career guidance, mental health support, and extracurricular activities. Our dedicated support team is available 24/7 to assist students with any challenges they may face during their learning journey.",
  "faq.answer.7":
    "Our program fees vary depending on the course level, duration, and format. We offer competitive pricing and flexible payment plans to make quality education accessible. Contact us for detailed pricing information and available scholarships or discounts.",
  "faq.answer.8":
    "Absolutely! We encourage prospective students and parents to visit our campus. You can schedule a guided tour, meet our educators, observe classes, and get a feel for our learning environment. Virtual tours are also available for those who cannot visit in person.",
  "faq.answer.9":
  ...
  "footer.about.description":
    "We are dedicated to providing world-class education that empowers students to achieve their full potential in a global society.",
  ...
  "programs.motivational-skills.desc":
  ...
  "programs.branding-diploma.desc":
  ...
  "programs.business-english.desc":
  ...
  "programs.professional-branding.title":
    "Professional Branding & Brand Management",
  "programs.professional-branding.desc":
  ...
  "programs.leadership-diploma.desc":
  ...
  "programs.ecommerce-diploma.desc":
  ...
  "programs.marketing-diploma.desc":
  ...
  "programs.advertising-diploma.desc":
  ...
  "programs.digital-marketing.desc":
  ...
  "programs.artificial-intelligence.desc":
  ...
  "programs.vendor-management.desc":
  ...
  "programs.finance-non-financial.desc":
  ...
  "programs.digital-transformation-finance.title":
    "Digital Transformation in Financial Services",
  "programs.digital-transformation-finance.desc":
  ...
  "programs.sustainable-hospitality.desc":
  ...
  "programs.special-education.desc":
    "Develop essential skills for working with children with special needs and creating inclusive learning environments.",
  ...
  "programs.behavior-modification.desc":
  ...
  "programs.learning-difficulties.desc":
  ...
  "programs.family-counseling.title":
    "Family Educational Psychological Counseling",
  "programs.family-counseling.desc":
  ...
  "programs.occupational-safety.title":
    "Occupational Safety and Crisis Management",
  "programs.occupational-safety.desc":
  ...
  "course.certificationDesc":
    "Upon successful completion, you'll receive an industry-recognized certificate that validates your expertise.",
  "course.readyToStart": "Ready to Start?",
  "course.joinProfessionals":
    "Join thousands of professionals who have advanced their careers with our programs.",
  ...
  "programs.motivational-skills.fullDesc":
  ...
  "programs.motivational-skills.highlight.0":
    "Develop compelling shared visions",
  "programs.motivational-skills.highlight.1":
    "Set effective goals and expectations",
  "programs.motivational-skills.highlight.2":
    "Understand cultural drivers of performance",
  "programs.motivational-skills.highlight.3":
    "Design incentive and reward systems",
  "programs.motivational-skills.highlight.4":
    "Diagnose motivational challenges",
  "programs.motivational-skills.curriculum.0":
    "Introduction to Motivational Leadership",
  "programs.motivational-skills.curriculum.1":
    "Vision Development and Communication",
  "programs.motivational-skills.curriculum.2":
    "Goal Setting and Performance Management",
  "programs.motivational-skills.curriculum.3": "Cultural Context in Motivation",
  "programs.motivational-skills.curriculum.4":
    "Incentive Design and Implementation",
  "programs.motivational-skills.curriculum.5":
    "Diagnostic Tools for Motivation",
  "programs.motivational-skills.curriculum.6":
    "Creating High-Performance Environments",
  "programs.motivational-skills.prerequisite.0": "Basic management experience",
  "programs.motivational-skills.prerequisite.1":
    "Understanding of team dynamics",
  "programs.motivational-skills.certificationName":
    "Professional Motivational Skills Diploma",

  // Branding Diploma Course Details
  "programs.branding-diploma.fullDesc":
  ...
  "programs.branding-diploma.highlight.0":
    "Master brand identity and positioning",
  "programs.branding-diploma.highlight.1":
  ...
  "programs.branding-diploma.highlight.4":
  ...
  "programs.branding-diploma.curriculum.4":
  ...
  "programs.branding-diploma.prerequisite.0":
    "Basic marketing knowledge helpful but not required",
  "programs.branding-diploma.certificationName":
    "Professional Branding Diploma",

  // Business English Course Details
  "programs.business-english.fullDesc":
  ...
  "programs.business-english.highlight.0":
    "Professional business communication",
  "programs.business-english.highlight.1":
  ...
  "programs.business-english.highlight.4":
    "Confidence in professional settings",
  "programs.business-english.curriculum.0":
  ...
  "programs.business-english.curriculum.3":
  ...
  "programs.business-english.certificationName":
    "Business English Communication Diploma",
...
const messagesAr = {
  ...
  "hero.subtitle": "تشكيل الرؤيويين للغد، اليوم",
  "hero.slogan": "تدرب اليوم، قد الغد",
  "hero.description":
    "في سجنتشر اكادمي، نرعى العقول الشابة من خلال التعليم عالمي المستوى المتجذر في {values} و{creativity} و{innovation}. برامجنا المعترف بها عالمياً ومعلمونا الخبراء يُعدون الطلاب بالمهارات والثقة والعقلية للازدهار في عالم متغير.",
  "hero.values": "القيم",
  ...
  "features.subtitle":
    "اكتشف ما يجعل أكاديميتنا الخيار المفضل لآلاف الطلاب والعائلات حول العالم.",
  ...
  "about.subtitle":
    "في سجنتشر اكادمي، نرعى عقول قادة المستقبل من خلال معيار لا يضاهى من التميز في التعليم. برامجنا المرموقة تمزج بين التقليد والابتكار، وتغرس القيم الخالدة والإبداع المصقول والرؤية الرائدة. موجهة بمعلمين عالميين ومثراة بمنظور عالمي.",
  "about.mission.title": "مهمتنا",
  "about.mission.text":
    "تقديم معيار لا يضاهى من التعليم يلهم التميز الفكري، ويزرع الإبداع المصقول، ويغرس إحساساً عميقاً بالنزاهة والهدف. في سجنتشر اكادمي، نشكل مواطنين عالميين متميزين مجهزين بالحكمة والقيادة والرقي الثقافي لإحداث تأثير دائم في العالم.",
  "about.vision.title": "رؤيتنا",
  "about.vision.text":
    "أن نقف كمؤسسة عالمية رائدة في التعلم النخبوي، نوحد الثقافات والأفكار بينما نضع معايير جديدة في الهيبة الأكاديمية. نتصور جيلاً من القادة - مثقفين، ذوي رؤية، ومبدئيين - الذين يشكلون المستقبل بالابتكار والرشاقة والتأثير التحويلي.",
  "about.values.title": "قيمنا الأساسية",
  "about.values.subtitle":
    "هذه المبادئ الأساسية توجه كل ما نفعله وتشكل ثقافة أكاديميتنا.",
  ...
  "about.values.excellence.desc":
    "الحفاظ على أعلى المعايير التعليمية بجودة لا تساوم",
  ...
  "about.values.global.desc": "إعداد قادة مثقفين ومتطورين لعالم مترابط",
  "about.values.leadership.title": "تطوير القيادة",
  "about.values.leadership.desc": "زراعة قادة رؤيويين ذوي تأثير تحويلي",
  "about.aboutUs.title": "عن أكاديمية سجنتشر",
  "about.aboutUs.text":
    "أكاديمية سجنتشر، الذراع التدريبي لمجموعة سجنتشر، تقدم برامج معتمدة متماشية مع رؤية مصر 2030 ومبادرة بداية الرئاسية. مع مدربين خبراء ومحتوى معتمد دولياً، تربط بين التعليم واحتياجات السوق في القطاعات الصحية والضيافة والتطوير المؤسسي.",
  ...
  "programs.subtitle":
    "من الطفولة المبكرة إلى الإعداد للثانوية العامة، صُممت برامجنا لرعاية النمو في كل مرحلة.",
  "programs.learnMore": "تعرف أكثر",
  "programs.early.title": "تعليم الطفولة المبكرة",
  "programs.early.desc":
    "بناء الأسس للأعمار 3-6 سنوات مع التعلم القائم على اللعب",
  ...
  "programs.cta.desc":
    "يمكن لمستشارينا التعليميين مساعدتك في العثور على البرنامج الأمثل الذي يناسب احتياجاتك واهتماماتك. نقدم لك استشارة مجانية لمدة 10 دقائق مع خبرائنا لإرشادك نحو الخيار الأمثل.",
  ...
  "stats.subtitle":
    "هذه الإنجازات تعكس التزامنا بالتميز والثقة التي تضعها العائلات فينا.",
  ...
  "testimonials.subtitle":
    "قصص حقيقية من العائلات التي تثق بنا في تعليم أطفالها.",

  // CTA Section
  "cta.title": "هل أنت مستعد لبدء",
  "cta.titleHighlight": "رحلة طفلك التعليمية؟",
  "cta.subtitle":
    "انضم إلى مجتمع العائلات التي اختارت التميز في التعليم. التسجيل مفتوح الآن للعام الأكاديمي القادم.",
  "cta.badge": "التسجيل مفتوح",
  "cta.card.title": "احجز مكان طفلك اليوم",
  "cta.card.desc":
    "أماكن محدودة متاحة لبرامجنا المتميزة. احجز زيارة لترى لماذا تختارنا العائلات لتعليم أطفالها.",
  ...
  "partners.subtitle":
    "نتعاون مع مؤسسات ومنظمات مرموقة حول العالم لتوفير أعلى جودة تعليمية وفرص لطلابنا.",
  ...
  "partners.benefits.quality.desc":
    "معايير عالية يتم الحفاظ عليها من خلال إشراف الشركاء",
  "partners.benefits.opportunities.title": "فرص محسنة",
  "partners.benefits.opportunities.desc":
    "الوصول إلى الفرص التعليمية والمهنية العالمية",
  ...
  "certificates.subtitle":
    "التزامنا بالتميز مُثبت من خلال شهادات وجوائز مرموقة من منظمات دولية معروفة.",
  ...
  "certificates.desc.1":
    "أنظمة إدارة المنظمات التعليمية - تعزيز رضا المتعلمين والمستفيدين والموظفين",
  "certificates.desc.2":
    "المعيار الدولي لأنظمة إدارة الجودة يضمن الجودة المستمرة ورضا العملاء",
  "certificates.desc.3":
    "اعتماد ضمان الجودة الوطني يظهر التزامنا بالتميز والتحسين المستمر",
  "certificates.desc.4":
    "اعتراف جمعية الاعتماد المهني الدولي المعتمد لتلبية المعايير الدولية",
  "certificates.awards.title": "الجوائز والإنجازات الحديثة",
  "certificates.awards.subtitle":
    "اعتراف بالتزامنا المستمر بالتميز والابتكار التعليمي",
  ...
  "certificates.quality.description":
    "معايير الجودة الصارمة لدينا تضمن أن كل برنامج يلبي المعايير الدولية للتميز التعليمي.",
  ...
  "faq.subtitle":
    "اعثر على إجابات للأسئلة الأكثر شيوعاً حول برامجنا وعملية القبول وخدماتنا. لا تجد ما تبحث عنه؟ تواصل معنا مباشرة.",
  ...
  "faq.answer.1":
    "نرحب بالطلاب من عمر 18 سنة فما فوق. برامجنا مصممة لتلبية احتياجات التعلم والأهداف التنموية للمتعلمين البالغين.",
  "faq.answer.2":
    "دوراتنا تُقدم باللغتين الإنجليزية والعربية. نؤمن بالتعليم ثنائي اللغة الذي يساعد الطلاب على أن يصبحوا منافسين عالمياً مع الحفاظ على هويتهم الثقافية. معظم برامجنا تقدم التدريس بكلا اللغتين، مع بعض الدورات المتخصصة المتوفرة بالإنجليزية فقط.",
  "faq.answer.3":
    "نعم بالتأكيد! شهاداتنا معتمدة دولياً ومتاح توثيقها من وزارة الخارجية.",
  "faq.answer.4":
    "عملية القبول لدينا بسيطة ومباشرة: 1) تقديم طلب عبر الإنترنت، 2) جدولة تقييم تحديد المستوى، 3) حضور مقابلة مع مستشارينا التعليميين، 4) تلقي رسالة القبول، 5) إكمال التسجيل. نقدم أيضاً استشارة مجانية لمدة 10 دقائق لمساعدتك في اختيار البرنامج المناسب.",
  "faq.answer.5":
    "نعم، نقدم خيارات تعلم مرنة تشمل الصفوف عبر الإنترنت والمختلطة والحضورية. منصة التعلم الرقمية لدينا توفر دروساً تفاعلية وفصولاً افتراضية ودعماً شاملاً. يمكن للطلاب اختيار الشكل الذي يناسب احتياجاتهم وجدولهم.",
  "faq.answer.6":
    "نقدم دعماً شاملاً يشمل التدريس الأكاديمي والإرشاد المهني ودعم الصحة النفسية والأنشطة اللامنهجية. فريق الدعم المخصص متاح 24/7 لمساعدة الطلاب في أي تحديات قد يواجهونها خلال رحلة التعلم.",
  "faq.answer.7":
    "رسوم برامجنا تختلف حسب مستوى الدورة والمدة والشكل. نقدم أسعاراً تنافسية وخطط دفع مرنة لجعل التعليم الجيد متاحاً. تواصل معنا للحصول على معلومات مفصلة عن الأسعار والمنح أو الخصومات المتاحة.",
  "faq.answer.8":
    "بالتأكيد! نشجع الطلاب المحتملين وأولياء الأمور على زيارة حرمنا الجامعي. يمكنك جدولة جولة موجهة ومقابلة معلمينا ومراقبة الصفوف والتعرف على بيئة التعلم لدينا. الجولات الافتراضية متاحة أيضاً لمن لا يستطيع الزيارة شخصياً.",
  "faq.answer.9":
    "نعم، نقدم كلاً من خيارات التعلم عبر الإنترنت والحضورية لتلبية الاحتياجات والتفضيلات المختلفة. توفر دوراتنا الحضورية تجربة فصول دراسية تقليدية مع تفاعل مباشر مع المعلمين وأنشطة عملية. بينما توفر الدورات عبر الإنترنت مرونة مع التعلم الذاتي والمحتوى الرقمي التفاعلي. يحافظ كلا النوعين على نفس معايير المناهج وقيمة الشهادة. كما نقدم خيارات هجينة تجمع بين النهجين، مما يسمح للطلاب بحضور بعض الجلسات شخصياً والبعض الآخر عن بُعد.",
  ...
  "footer.about.description":
    "نحن ملتزمون بتوفير تعليم عالمي المستوى يمكن الطلاب من تحقيق إمكاناتهم الكاملة في مجتمع عالمي.",
  ...
  "programs.psychometrics.desc":
    "التأهل لاستخدام أدوات القياس النفسي بشكل احترافي وفقًا للمعايير الدولية في التشخيص النفسي.",
  ...
  "programs.behavior-modification.desc":
    "تعلم تحليل أنماط السلوك البشري وتطبيق استراتيجيات فعالة لتعديل السلوك استنادًا إلى علم النفس السلوكي.",
  ...
  "programs.learning-difficulties.desc":
    "فهم وتشخيص وعلاج صعوبات التعلم لدى الأطفال والمراهقين باستخدام الطرق العلمية والأدوات المعتمدة.",
  ...
  "programs.montessori.desc":
    "تطبيق منهجية مونتيسوري في تعليم الطفولة المبكرة اتباعًا لفلسفة الدكتورة ماريا مونتيسوري في تنمية الطفل.",
  ...
  "programs.family-counseling.desc":
    "اكتساب مهارات في الإرشاد النفسي الذي يدمج الجوانب النفسية والتعليمية والأسرية للدعم الشامل.",
  ...
  "programs.occupational-safety.desc":
    "تعلم تطبيق معايير السلامة في بيئات العمل والتعامل بكفاءة مع حالات الطوارئ لحماية الأرواح والممتلكات.",
  ...
  "course.certificationDesc":
    "عند الانتهاء بنجاح، ستحصل على شهادة معترف بها في الصناعة تؤكد خبرتك.",
  "course.readyToStart": "مستعد للبدء؟",
  "course.joinProfessionals":
    "انضم إلى آلاف المهنيين الذين طوروا مسيرتهم المهنية مع برامجنا.",
  ...
  "programs.branding-diploma.highlight.4":
    "بناء قيمة العلامة التجارية وإدارة السمعة",
  "programs.branding-diploma.curriculum.0": "أساسيات العلامة التجارية",
  "programs.branding-diploma.curriculum.1":
  ...
  "programs.business-english.certificationName":
    "دبلوم التواصل باللغة الإنجليزية للأعمال",
...
export const ClientIntlProvider: React.FC<ClientIntlProviderProps> = ({
  children,
}) => {
