...
const messagesEn = {
  ...
  'certificates.name.3': 'NQA Certification',
  ...
  'faq.answer.1': 'We welcome students from age 3 to 18 years old. Our programs are designed for different age groups: Early Childhood (3-6 years), Elementary (6-12 years), and Secondary (12-18 years). Each program is tailored to the developmental needs and learning capabilities of the respective age group.',
  ...
  'faq.answer.3': 'Yes, absolutely! Our certificates are internationally recognized and accredited by prestigious organizations including Cambridge Assessment, British Council, and other international bodies. Our graduates have successfully pursued higher education and careers worldwide.',
...
const messagesAr = {
  ...
  'faq.answer.1': 'نرحب بالطلاب من عمر 3 إلى 18 سنة. برامجنا مصممة للفئات العمرية المختلفة: الطفولة المبكرة (3-6 سنوات)، الابتدائية (6-12 سنة)، والثانوية (12-18 سنة). كل برنامج مُخصص للاحتياجات التنموية وقدرات التعلم للفئة العمرية المعنية.',
  ...
  'faq.answer.3': 'نعم، بالتأكيد! شهاداتنا معترف بها دولياً ومعتمدة من منظمات مرموقة منها تقييم كامبريدج والمجلس الثقافي البريطاني وهيئات دولية أخرى. خريجونا نجحوا في متابعة التعليم العالي والمهن حول العالم.',
