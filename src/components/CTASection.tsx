...
import { ArrowRight, Phone, Mail, MapPin, Calendar, Star, Users, BookOpen, Award, MessageCircle, Clock, CheckCircle, Sparkles, Heart, Target } from 'lucide-react';
...
const CTASection = () => {
  ...
  const handleWhatsAppConsultation = () => {
    ...
    const message = encodeURIComponent('مرحباً! أريد الحصول على استشارة مجانية لمدة 10 دقائق حول البرامج التعليمية المتاحة في سيجنتشر أكاديمي. Hello! I would like to get a free 10-minute consultation about the educational programs available at Signature Academy.');
    ...
    <section className="py-20 bg-gradient-to-br from-blue-600 via-purple-600 to-indigo-700 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <h2 className={`text-4xl md:text-6xl font-bold text-white mb-6 leading-tight ${direction === 'rtl' ? 'text-right' : 'text-left'} sm:text-center`}>
            <Message 
              id="cta.title" 
              fallback="Ready to Begin Your Child's" 
            />
            <span className="block mt-2 animate-gradient bg-gradient-to-r from-cyan-300 via-blue-200 to-purple-300 bg-clip-text text-transparent">
              <Message 
          ...
          <p className={`text-xl text-blue-100 max-w-4xl mx-auto leading-relaxed ${direction === 'rtl' ? 'text-right' : 'text-left'} sm:text-center`}>
            <Message 
              id="cta.subtitle" 
          ...
          <div className="space-y-8">
                ...
                <div className="relative group overflow-hidden rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-500">
                  ...
                  <div className="absolute bottom-4 left-4 text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    ...
                    <p className="text-sm font-medium">
                      <Message id="cta.interactiveLearning" fallback="Interactive Learning" />
                    </p>
                  </div>
                </div>
                  ...
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <div>
                      <h4 className="text-white font-semibold">
                        <Message id="cta.expertGuidance" fallback="Expert Guidance" />
                      </h4>
                      <p className="text-blue-200 text-sm">
                        <Message id="cta.personalizedConsultation" fallback="Personalized consultation" />
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="space-y-4 mt-8">
                <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 animate-fade-in-up-delay">
                  <div className="flex items-center space-x-3 mb-2">
                    ...
                    <div>
                      <h4 className="text-white font-semibold">
                        <Message id="cta.programsCount" fallback="18+ Programs" />
                      </h4>
                      <p className="text-blue-200 text-sm">
                        <Message id="cta.professionalDiplomas" fallback="Professional diplomas" />
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="relative group overflow-hidden rounded-2xl shadow-2xl transform hover:scale-105 transition-all duration-500">
                  <div className="w-full h-48 bg-gradient-to-br from-blue-500/20 to-purple-500/20 flex items-center justify-center border border-white/20">
                    <div className="text-center text-white">
                      <Award className="w-16 h-16 mx-auto mb-4 opacity-60" />
                      <p className="text-lg font-semibold">
                        <Message id="cta.certifiedPrograms" fallback="Certified Programs" />
                      </p>
                      <p className="text-sm text-blue-200">
                        <Message id="cta.industryRecognition" fallback="Industry Recognition" />
                      </p>
                    </div>
                  </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 text-center hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-blue-200 text-sm">
                  <Message id="cta.quickConsultation" fallback="Quick consultation" />
                </p>
              </div>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 text-center hover:bg-white/20 transition-all duration-300 transform hover:-translate-y-1">
                ...
                <p className="text-blue-200 text-sm">
                  <Message id="cta.instantResponse" fallback="Instant response" />
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-8 border border-white/20 shadow-2xl">
              <div className="text-center mb-6">
                ...
                <p className="text-blue-200">
                  <Message id="cta.freeExpertGuidance" fallback="Free 10-minute expert guidance" />
                </p>
              </div>
              ...
              >
                ...
                <span>
                  <Message id="cta.startWhatsappConsultation" fallback="Start WhatsApp Consultation" />
                </span>
                <ArrowRight className={`w-5 h-5 group-hover:translate-x-1 transition-transform duration-300 ${direction === 'rtl' ? 'rotate-180 group-hover:-translate-x-1' : ''}`} />
              </button>
              ...
              <div className="mt-6 text-center">
                <div className="flex items-center justify-center space-x-2 text-blue-200 text-sm">
                  ...
                  <span>
                    <Message id="cta.noCommitment" fallback="No commitment required" />
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                ...
                <div className={`flex items-start space-x-4 group hover:bg-white/10 rounded-lg p-3 transition-all duration-300 ${direction === 'rtl' ? 'space-x-reverse' : ''}`}>
                  ...
                  <div>
                    ...
                    <p className="text-blue-200 text-sm">
                      <Message id="cta.contact.address" fallback="Visit our campus" />
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="text-center group">
            ...
            <p className="text-blue-200 leading-relaxed">
              <Message id="cta.features.flexible.desc" fallback="Multiple enrollment periods throughout the year" />
            </p>
          </div>
          ...
          <div className="text-center group">
            ...
            <p className="text-blue-200 leading-relaxed">
              <Message id="cta.features.support.desc" fallback="Always here to help with any questions" />
            </p>
          </div>
          ...
          <div className="text-center group">
            ...
            <h4 className="text-xl font-bold text-white mb-3 group-hover:text-emerald-300 transition-colors duration-300">
              <Message id="cta.features.easy.title" fallback="Easy Application" />
            </h4>
            <p className="text-blue-200 leading-relaxed">
              <Message id="cta.features.easy.desc" fallback="Simple online application process" />
            </p>
          </div>
        </div>
      </div>
