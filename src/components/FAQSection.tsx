  ...
  const faqs = [
    {
      ...
      answer:
        "We welcome students from age 3 to 18 years old. Our programs are designed for different age groups: Early Childhood (3-6 years), Elementary (6-12 years), and Secondary (12-18 years). Each program is tailored to the developmental needs and learning capabilities of the respective age group.",
    },
    {
      id: 2,
    ...
    },
    {
      ...
      answer:
        "Yes, absolutely! Our certificates are internationally recognized and accredited by prestigious organizations including Cambridge Assessment, British Council, and other international bodies. Our graduates have successfully pursued higher education and careers worldwide.",
    },
    {
      id: 4,
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-sm text-green-800">
                    <Message
                      id="faq.tips.tip2"
                      fallback="Visit our campus to see the facilities"
                    />
                  </p>
                </div>
                ...
                <div className="flex items-start space-x-2">
                  ...
                  <p className="text-sm text-green-800">
                    <Message
                      id="faq.tips.tip3"
                      fallback="Ask about payment plans and scholarships"
                    />
                  </p>
                </div>
              </div>
